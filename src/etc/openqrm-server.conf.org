...
OPENQRM_MINOR_RELEASE_VERSION="54"
...
if [ -f /etc/debian_version ]; then
	OPENQRM_SERVER_DEPENDENCIES="apache2, php, php-soap, php-mysql, php-xml, libphp-adodb, mariadb-client, mariadb-server, pxelinux, screen, procmail, openssl, dropbear, libapache2-mod-php, net-tools"
